...
var localStorage = {
 ...
 setItem: function(key, value) {
   localStorage.__dict[key] = value;
   localStorage.length = Object.keys(localStorage.__dict).length;
 },
 getItem: function(key) {
   return localStorage.__dict[key]
 },
 removeItem: function(key) {
   delete(localStorage.__dict[key]);
   localStorage.length = Object.keys(localStorage.__dict).length;
 },
 key: function(n) {
   return Object.keys(localStorage.__dict)[n];
 },
 clear: function() {
   localStorage.__dict = {};
...
var environment_1 = require("@tensorflow/tfjs-core/dist/environment");
var util_1 = require("@tensorflow/tfjs-core/dist/util");
var io_utils_1 = require("@tensorflow/tfjs-core/dist/io/io_utils");
var model_management_1 = require("@tensorflow/tfjs-core/dist/io/model_management");
var router_registry_1 = require("@tensorflow/tfjs-core/dist/io/router_registry");
var PATH_SEPARATOR = '/';
...
var BrowserLocalStorageManager = /** @class */ (function () {
    function BrowserLocalStorageManager() {
        ...
        // util_1.assert(typeof localStorage !== 'undefined', function () { return 'Current browser does not appear to support localStorage'; });
        this.LS = localStorage;
    }
